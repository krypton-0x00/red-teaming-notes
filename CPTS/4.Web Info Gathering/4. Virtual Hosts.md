...
```shell-session
shakir0x00@htb[/htb]$ gobuster vhost -u http://<target_IP_address> -w <wordlist_file> --append-domain
```
...
```shell-session
shakir0x00@htb[/htb]$ gobuster vhost -u http://inlanefreight.htb:81 -w /usr/share/seclists/Discovery/DNS/subdomains-top1million-110000.txt --append-domain
===============================================================
Gobuster v3.6
...
```rb
nesu@athenaos ~> gobuster vhost -u http://inlanefreight.htb:58808 -w /usr/share/seclists/Discovery/DNS/subdomains-top1million-110000.txt --append-domain
===============================================================
Gobuster v3.6
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@firefart)
===============================================================
[+] Url:             http://inlanefreight.htb:58808
[+] Method:          GET
[+] Threads:         10
[+] Wordlist:        /usr/share/seclists/Discovery/DNS/subdomains-top1million-110000.txt
[+] User Agent:      gobuster/3.6
...
Starting gobuster in VHOST enumeration mode
===============================================================
Found: blog.inlanefreight.htb:58808 Status: 200 [Size: 98]
Found: admin.inlanefreight.htb:58808 Status: 200 [Size: 100]
Found: forum.inlanefreight.htb:58808 Status: 200 [Size: 100]
Found: support.inlanefreight.htb:58808 Status: 200 [Size: 104]
Found: vm5.inlanefreight.htb:58808 Status: 200 [Size: 96]
Found: browse.inlanefreight.htb:58808 Status: 200 [Size: 102]
Found: web17611.inlanefreight.htb:58808 Status: 200 [Size: 106]
Progress: 18441 / 114442 (16.11%)^C
[!] Keyboard interrupt detected, terminating.
Progress: 18448 / 114442 (16.12%)
===============================================================
Finished
===============================================================
