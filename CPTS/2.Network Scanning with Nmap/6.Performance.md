...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
...
```shell-session
shakir0x00@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l
...
```shell-session
shakir0x00@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l
...
```shell-session
shakir0x00@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l
