...
```shell 
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.28 -p 21,22,25 -sS -Pn -n --disable-arp-ping --packet-trace
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.28 -n -Pn -p445 -O
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.28 -p50000 -sS -Pn -n --disable-arp-ping --packet-trace
