...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap <target> -sC
```
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap <target> --script <category>
```
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```shell-session
shakir0x00@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
