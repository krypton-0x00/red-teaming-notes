...
```rb
shakir0x00@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p3389 --packet-trace --disable-arp-ping -n
...
```rb
shakir0x00@htb[/htb]$ git clone https://github.com/CiscoCXSecurity/rdp-sec-check.git && cd rdp-sec-check
shakir0x00@htb[/htb]$ ./rdp-sec-check.pl 10.129.201.248
...
```rb
shakir0x00@htb[/htb]$ xfreerdp /u:cry0l1t3 /p:"P455w0rd!" /v:10.129.201.248
