...
```shell-session
shakir0x00@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```shell-session
shakir0x00@htb[/htb]$ sudo apt install onesixtyone
shakir0x00@htb[/htb]$ onesixtyone -c /opt/useful/seclists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```shell-session
shakir0x00@htb[/htb]$ sudo apt install braa
shakir0x00@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
shakir0x00@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
